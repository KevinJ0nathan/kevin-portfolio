      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden pb-4 pt-4 custom-scrollbar">
        ...
        >
          <p className="font-bold text-lg text-white mb-2">
            Project Brief: Shoply 🛍️
          </p>
          <p className="text-d-text-normal mb-2">
            Traditional offline businesses often struggle with inventory
            mismanagement and limited customer reach.
            <b> Shoply</b> is a solution designed to solve this by providing a
            streamlined online retail platform.
          </p>
          <p className="text-d-text-normal">
            This wasn't just a UI project, the main challenge was architecting a{" "}
            <b>MySQL database</b> that ensures data integrity.
          </p>
        </Message>
        ...
        >
          <DiscordEmbed title="🛠️ Technical Specifications" color="#00A8FC">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <p className="text-xs font-bold text-d-text-muted uppercase">
                  Backend
                </p>
        ...
        >
          <p className="mb-2 text-d-text-normal">
            ...
            <strong>Database Normalization</strong>. We took the schema from{" "}
            <b>1NF</b> all the way to <b>3NF</b> to reduce redundancy.
          </p>

          <div className="bg-d-background-secondary p-4 rounded border-l-4 border-yellow-500 my-2">
            <p className="text-xs font-bold text-yellow-500 uppercase mb-1">
              ⚠️ Engineering Challenge
            </p>
            <p className="text-sm text-d-text-normal italic">
              "We deliberately broke normalization rules for the{" "}
              <strong>Orders</strong> table."
            </p>
            <p className="text-sm text-d-text-normal mt-2">
              In the <code>Orders</code> table, we decided to store the{" "}
              <code>TotalPrice</code> directly. Normally, you calculate this
              dynamically. However, if product prices change in the future, the
              historical order history would become inaccurate. Storing the
              snapshot price prevents this data integrity issue.
            </p>
          </div>

          <div className="mt-4">
            <p className="text-xs font-bold text-d-text-muted mb-1">
              ENTITY RELATIONSHIP DIAGRAM (ERD)
            </p>
            <img
              alt="Database Schema"
              src={shoplyERD}
              className="rounded-lg max-w-full md:max-w-lg cursor-pointer hover:shadow-lg transition-shadow"
            />
          </div>
        </Message>
        ...
        >
          <p className="mb-2 text-d-text-normal">
            Here is a snippet of the DDL (Data Definition Language) for the
            Customers table, implementing constraints for email validation and
            password security.
          </p>
        ...
        >
          <p className="mb-2 text-d-text-normal">
            And finally, the User Interface. We built a responsive dashboard
            allowing users to filter categories and track their order status.
          </p>
          <img
            alt="Shoply Dashboard"
            src={shoplyDashboard}
            className="rounded-lg w-full max-w-2xl mt-2 border border-d-background-tertiary"
          />
        </Message>
        ...
        >
          <p className="mb-2 text-d-text-normal">
            You can read the full documentation (including the complete SQL code
            and testing scenarios) here:
          </p>
          <FileAttachment
