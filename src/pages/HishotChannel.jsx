      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden pb-4 pt-4 custom-scrollbar">
        ...
        >
          <p className="font-bold text-lg text-white mb-2">
            Project Brief: HISHOT 2024 ✈️
          </p>
          <p className="text-d-text-normal mb-2">
            <strong>HISHOT</strong> (HIMTI Seminar Workshop and Study Tour) is a
            massive annual event featuring a Seminar, 2 Workshops, and both
            Domestic & International Study Tours (Malaysia).
          </p>
          <p className="text-d-text-normal">
            The event attracted over <strong>200+ registrants</strong> across
            all activities. My team was responsible for building the{" "}
            <strong>Official Landing Page</strong> that served as the central
            information hub and marketing portal for these events.
          </p>
        </Message>
        ...
        >
          <p className="mb-2 text-d-text-normal">
            While the registration data was handled via external platforms
            (Google Docs & Organization Portal), my landing page was the
            critical "first impression" that converted visitors into
            registrants.
          </p>

          <div className="mt-3 pl-3 border-l-4 border-green-500 bg-d-background-secondary/30 p-2 rounded-r">
            <p className="font-bold text-green-400 text-xs uppercase tracking-wide mb-1">
              🚀 Operational Efficiency
            </p>
            <p className="text-d-text-normal text-sm">
              Beyond the frontend, I also helped streamline operations by{" "}
              <strong>
                automating promotional emails and e-certificate distribution
              </strong>
              . This script reduced the committee's manual workload by roughly{" "}
              <strong>80%</strong>, ensuring all 200+ participants received
              their documents instantly.
            </p>
          </div>
        </Message>
        ...
        >
          <p className="mb-2 text-d-text-normal">
            Here is the landing page design. We used a "Dark Mode" aesthetic
            with neon green accents to align with the Cyber Security seminar
            theme.
          </p>
