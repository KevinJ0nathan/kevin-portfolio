      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden pb-4 pt-4 custom-scrollbar">
        ...
        >
          <p className="font-bold text-lg text-white mb-2">
            Project Brief: Dentalign Case Study (Unofficial) 🏥
          </p>

          <p className="text-d-text-normal mb-2">
            I engineered a <strong>functional prototype</strong> of a{" "}
            <strong>Helpdesk Ticketing System</strong> using{" "}
            <span className="text-white font-bold">Dentalign</span> (a real
            clinic in Jakarta) as a case study for the brand identity.
          </p>

          <p className="text-d-text-normal mb-2">
            <em>
              **Note: This is an independent concept project and is not
              officially affiliated with the clinic. I used their branding to
              demonstrate my ability to build complex full-stack solutions.**
            </em>
          </p>

          <p className="text-d-text-normal">
            The goal was to solve a common industry struggle: managing patient
            complaints via WhatsApp. I built this centralized web platform to
            streamline support requests for Customers, Staff, and Admins.
          </p>
        </Message>
        ...
        >
          ...
          <DiscordEmbed title="🛠️ System Architecture" color="#6C5CE7">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <p className="text-xs font-bold text-d-text-muted uppercase text-blue-400">
                  Deployment
                </p>
        ...
        >
          <p className="mb-2 text-d-text-normal">
            The main technical challenge was implementing a secure{" "}
            <strong>Role-Based Access Control (RBAC)</strong> system. The app
            serves three distinct user groups with different permissions:
          </p>
          ...
          <div className="bg-d-background-secondary p-4 rounded border-l-4 border-purple-500 my-2 grid gap-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-d-text-normal">
                Full CRUD access to manage ticket priority and resolution
                status.
              </span>
            </div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-d-text-normal">
                Can file internal reports (e.g., Equipment Maintenance, Supply
                Shortage).
              </span>
            </div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-d-text-normal">
                Can track appointment issues and account recovery.
              </span>
            </div>
          </div>
        </Message>
        ...
        >
          <p className="mb-2 text-d-text-normal">
            I designed the frontend using <strong>React.js</strong> to be fully
            responsive. Below is the Admin Dashboard allowing for real-time
