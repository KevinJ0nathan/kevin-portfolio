      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden pb-4 pt-4 custom-scrollbar">
        ...
        >
          <p className="text-d-text-normal">
            A timeline of my professional roles, leadership positions, and
            internships.
          </p>
        </Message>
        ...
        >
          ...
          >
            <p className="text-d-text-normal text-sm mb-2">
              Leading the Web Development division for the Greater Jakarta
              region.
            </p>
            <ul className="list-disc list-inside text-d-text-muted text-xs space-y-1">
              <li>
                <strong>Leadership:</strong> Managing and mentoring 70+ active
                members in the division.
              </li>
              <li>
                <strong>DevOps:</strong> Maintaining official websites using
                cPanel and managing MySQL databases.
              </li>
              <li>
                <strong>Development:</strong> Overseeing full-stack updates
                (Laravel/React) for organizational platforms.
              </li>
            </ul>
          </DiscordEmbed>
        </Message>
        ...
        >
          ...
          >
            <p className="text-d-text-normal text-sm mb-2">
              Coordinated the digital presence for an international study tour &
              seminar event.
            </p>
            <ul className="list-disc list-inside text-d-text-muted text-xs space-y-1">
              <li>
                <strong>Team Lead:</strong> Led a 7-member developer team to
                build the event website.
              </li>
              <li>
                <strong>Reliability:</strong> Ensured 100% uptime and
                responsiveness during live event operations.
              </li>
              <li>
                <strong>Automation:</strong> Automated e-certificate
                distribution, cutting manual workload by 80%.
              </li>
            </ul>
            <div className="mt-2 text-xs">
              <span className="text-d-text-link cursor-pointer hover:underline">
                #hishot-2024-landing
              </span>
        ...
        >
          ...
          >
            ...
            <ul className="list-disc list-inside text-d-text-muted text-xs space-y-1">
              <li>
                <strong>Soft Skills:</strong> Collaborated with a team to ensure
                efficient service during peak hours.
              </li>
              <li>
                <strong>Adaptability:</strong> Learned operational workflows
                quickly in a high-pressure setting.
              </li>
            </ul>
          </DiscordEmbed>
        </Message>
