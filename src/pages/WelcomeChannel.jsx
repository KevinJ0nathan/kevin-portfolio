    ...
    <div className="flex flex-col h-full bg-d-background-primary">
      <div className="flex-1 overflow-y-auto overflow-x-hidden pb-4 pt-4 custom-scrollbar">
        ...
        <div className="flex items-center gap-3 text-d-text-muted text-sm mb-6 ml-6 hover:bg-d-background-secondary py-1 -mx-2 px-2 rounded group transition-colors">
          <span className="text-d-status-online text-lg">
            <FaArrowRight />
          </span>
          <span>
            ...
            have just slid into the server. Say hi! 👋
          </span>
        </div>
        ...
        >
          <DiscordEmbed title="👋 WELCOME TO THE SERVER!" image={kevinAvatar}>
            <p className="mb-4 text-d-text-normal">
              Beep boop! I've loaded the portfolio of{" "}
              <span className="font-bold text-white">Kevin Jonathan</span>. Use
              the sidebar on the left to navigate.
            </p>
            ...
            <div>
              ...
              <p className="text-d-text-muted text-sm mb-2 leading-relaxed">
                Check the <span className="font-bold text-white">PROJECTS</span>{" "}
                category in the sidebar. Each channel represents a specific app
                or case study:
              </p>
        ...
        >
          ...
          <div className="mb-4 text-d-text-normal leading-relaxed">
            <p className="mb-2">
              ...
              <em>"Why use a Discord interface for a portfolio?"</em>
            </p>
            <p>
              Simply put, this is my digital headquarters. It’s where I
              coordinate university assignments with teammates, manage the{" "}
              <strong>HIMTI</strong> development team, and hop on calls to game
              with friends.
            </p>
            <p className="mt-2">
              I wanted my portfolio to reflect the space where I collaborate,
              learn, and stay connected with my community every day.
            </p>
          </div>
          ...
          <div className="pl-3 border-l-4 border-d-interactive-primary bg-d-background-secondary/20 py-2 rounded-r">
            <p className="text-d-text-normal">
              I'm a <strong>Computer Science student</strong> (GPA 3.93) at{" "}
              <span className="text-white font-bold">Binus International</span>,
              specializing in <strong>Full-Stack Web Development</strong>.
            </p>
            <p className="text-d-text-muted text-sm mt-1">
              Currently leading 70+ developers at HIMTI & preparing for my
              Double Degree at RMIT Melbourne.
            </p>
          </div>
        </Message>
        ...
        >
          <p className="mb-2 text-d-text-normal">
            If you'd like to keep a copy for your records or share my profile
            with your team, I've attached my full resume below. 👇
          </p>
